...
[dependencies-url]: https://david-dm.org/tunnckoCore/hq?path=packages/rolldown
[dependencies-img]: https://badgen.net/david/dep/tunnckoCore/hq?label=deps&path=packages/rolldown
