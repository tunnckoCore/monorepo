...
[Become a Partner or Sponsor?][patreon-url] :dollar: Check the **Partner**, **Sponsor** or **Omega-level** tiers! :tada: You can get your company logo, link & name on this file. It's also rendered on package page in [npmjs.com][npmv-url] and [yarnpkg.com](https://yarnpkg.com/en/package/rolldown) sites too! :rocket:
...
[npmv-url]: https://www.npmjs.com/package/rolldown
[npmv-img]: https://badgen.net/npm/v/rolldown?icon=npm
...
[license-url]: /LICENSE
[license-img]: https://badgen.net/npm/license/rolldown
...
[dependencies-url]: https://david-dm.org/tunnckoCore/hq?path=packages/rolldown&type=dep
[dependencies-img]: https://badgen.net/david/dep/tunnckoCore/hq/packages/rolldown?label=deps
...
[downloads-weekly-img]: https://badgen.net/npm/dw/rolldown
[downloads-monthly-img]: https://badgen.net/npm/dm/rolldown
[downloads-total-img]: https://badgen.net/npm/dt/rolldown
...
[shareu]: https://twitter.com/intent/tweet?text=https://github.com/tunnckoCore/hq/packages/rolldown&via=tunnckoCore
