...
[dependencies-url]: https://david-dm.org/tunnckoCore/hq?path=packages/parse-commit-message
[dependencies-img]: https://badgen.net/david/dep/tunnckoCore/hq?label=deps&path=packages/parse-commit-message
