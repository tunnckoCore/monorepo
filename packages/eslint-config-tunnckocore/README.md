# eslint-config-tunnckocore [![npm version][npmv-img]][npmv-url] [![License][license-img]][license-url]
...
[dependencies-url]: https://david-dm.org/tunnckoCore/hq?path=packages/foo-bar-baz-qux&type=dep
