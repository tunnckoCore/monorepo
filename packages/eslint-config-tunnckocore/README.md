...
[dependencies-url]: https://david-dm.org/tunnckoCore/hq?path=packages/eslint-config-tunnckocore
[dependencies-img]: https://badgen.net/david/dep/tunnckoCore/hq?label=deps&path=packages/eslint-config-tunnckocore
