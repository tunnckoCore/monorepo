...
[dependencies-url]: https://david-dm.org/tunnckoCore/hq?path=packages/foo-bar-baz-qux
[dependencies-img]: https://badgen.net/david/dep/tunnckoCore/hq?label=deps&path=packages/foo-bar-baz-qux
