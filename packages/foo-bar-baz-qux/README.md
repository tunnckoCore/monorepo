# foo-bar-baz-qux [![npm version][npmv-img]][npmv-url] [![License][license-img]][license-url]
...
[Become a Partner or Sponsor?][patreon-url] :dollar: Check the **Partner**, **Sponsor** or **Omega-level** tiers! :tada: You can get your company logo, link & name on this file. It's also rendered on package page in [npmjs.com][npmv-url] and [yarnpkg.com](https://yarnpkg.com/en/package/foo-bar-baz-qux) sites too! :rocket:
...
[npmv-url]: https://www.npmjs.com/package/foo-bar-baz-qux
[npmv-img]: https://badgen.net/npm/v/foo-bar-baz-qux?icon=npm
...
[license-url]: /LICENSE
[license-img]: https://badgen.net/npm/license/foo-bar-baz-qux
...
[dependencies-url]: https://david-dm.org/tunnckoCore/hq?path=packages/foo-bar-baz-qux&type=
[dependencies-img]: https://badgen.net/david/dep/tunnckoCore/hq/packages/foo-bar-baz-qux?label=deps
...
[downloads-weekly-img]: https://badgen.net/npm/dw/foo-bar-baz-qux
[downloads-monthly-img]: https://badgen.net/npm/dm/foo-bar-baz-qux
[downloads-total-img]: https://badgen.net/npm/dt/foo-bar-baz-qux
...
[shareu]: https://twitter.com/intent/tweet?text=https://github.com/tunnckoCore/hq/packages/foo-bar-baz-qux&via=tunnckoCore
